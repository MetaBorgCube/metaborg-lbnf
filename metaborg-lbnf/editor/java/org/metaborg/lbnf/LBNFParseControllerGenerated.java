...
public class LBNFParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("LBNF");
  ...
  { 
    LBNFParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = LBNFParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = LBNFParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(LBNFParseControllerGenerated.class);
    }
  ...
  { 
    return LBNFParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
